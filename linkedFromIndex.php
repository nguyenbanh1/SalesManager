				...
				<div class="homeproduct">
					<?php
						...
						if (isset($_GET["idCategory"])) {
							$sql = "select idProduct, nameProduct, price, imageName, idCategory from product where idCategory = ".$_GET["idCategory"]." order by dateCreated desc limit 15 offset ".$offsetCurrent;	
							...
							$sql = "select idProduct, nameProduct, price, imageName, idCategory from product where idProducer = ".$_GET["idProducer"]." order by dateCreated desc limit 15 offset ".$offsetCurrent;
				...
				<nav class="numbering">
                    <div class="fixPagination paging-top">
                        ...
                        ?>
                            <a href=<?php 
										if ($count <= 15) {
											echo '"linkedFromIndex.php?'.$choose.'&offset=0"';
										} else {
